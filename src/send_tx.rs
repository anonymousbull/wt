use crate::constant::{rpc1, rpc2, rpc3, jito1, jito2};
use crate::trade::{TradeRequest, TradeResponseResult};
use base64::Engine;
...
impl SendTx for RpcClient {
    async fn send_tx(&self, tx: Transaction, _: Option<SendTxConfig>) -> anyhow::Result<String> {
...
pub async fn send_tx(req: TradeRequest, cfg:Option<SendTxConfig>) -> FuturesUnordered<JoinHandle<TradeResponseResult>> {
